...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("LabSmartAI PRO – Sistema Inteligente de Laboratório")
        ...
        for i, (name, widget) in enumerate(buttons):
            ...
            btn.clicked.connect(lambda _, index=i: self.stacked_widget.setCurrentIndex(index))  # Corrigido aqui
